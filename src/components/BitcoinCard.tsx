...
export function BitcoinCard({ sats, usd, state }: BitcoinCardProps) {
    ...
    >
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-1">
          ...
          />
          <span className="text-bitcoin font-semibold uppercase tracking-wider text-[0.75rem]">
            Bitcoin
          </span>
        </div>
      ...
      <div className="space-y-1 min-h-[40px]">
        ...
        {isLoading ? (
          ...
          <div className="text-[1.35rem] font-semibold leading-snug text-foreground">
            {satsDisplay} sats
          </div>
        )}
